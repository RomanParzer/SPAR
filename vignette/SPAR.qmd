...
We exemplify how a new screening coefficients based on 
...
generate_scr_rasen <- function(scrcoef, data) {
  ra_screen <- RaSEn::RaScreen(xtrain = data$x, 
                       ytrain = data$y,
                       model = "lm", k = 3,
                       criterion = 'bic')
  coefs <- ra_screen$selected.perc 
  coefs
}
```
