...
2.   Standardize the $(n\times p)$ matrix of predictors $X$ by subtracting the sample column mean and dividing by the sample standard deviation. Additionally, for Gaussian response standardize $y$ by subtracting the sample mean and dividing by the sample standard deviation.
