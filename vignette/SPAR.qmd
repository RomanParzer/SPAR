...
distribution function $\mathbb{P}(X\leq x|Y)$ [@cui2015model].
...
@parzer2024sparse propose employing ${D_{ii}=\hat \alpha}$ in the sparse embedding matrix of @Clarkson2013LowRankApproxShort, $\hat \alpha$ is a screening coefficient in the regression such as the ridge or the HOLP coefficients, and show that the proposed projection increases the predictive performance in 
