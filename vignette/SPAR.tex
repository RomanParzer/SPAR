...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, enhanced, interior hidden, sharp corners, borderline west={3pt}{0pt}{shadecolor}, frame hidden, breakable]}{\end{tcolorbox}}\fi
\makeatother
...
\pkg{SPAR} is a new package for \proglang{R} \citep{RLanguage} designed
...
leveraging \proglang{R}'s \proglang{S}3 classes, making the process
...
\pkg{SPAR}'s suitability across a range of high-dimensional
applications.
...
predictors in reduced. Most notably, package \pkg{RPEnsemble}
...
Furthermore, several packages in \proglang{R} provide functionality for
random projections. For instance, package \pkg{RandPro}
...
\pkg{SPCAvRP} \citep{SPCAvRPR} implements sparse principal component
...
extensive array of packages available in \proglang{R}. An overview of
some notable packages on the Comprehensive \proglang{R} Archive Network
(CRAN) includes the following packages. Package \pkg{SIS} \citep{SISR},
...
procedure. Package \pkg{VariableScreening} \citep{pkg:VariableScreening}
...
#>               nu=1.53e-02 leading to 592 / 2000 active predictors.
#> Summary of those non-zero coefficients:
#>     Min.  1st Qu.   Median     Mean  3rd Qu.     Max. 
#> -1.02824 -0.15215  0.10434  0.05272  0.22101  1.93862
\end{verbatim}
...
{\centering \includegraphics[width=0.5\textwidth,height=\textheight]{SPAR_files/figure-pdf/unnamed-chunk-32-1.pdf}
...
{\centering \includegraphics[width=0.8\textwidth,height=\textheight]{SPAR_files/figure-pdf/unnamed-chunk-36-1.pdf}
...
{\centering \includegraphics[width=0.8\textwidth,height=\textheight]{SPAR_files/figure-pdf/unnamed-chunk-39-1.pdf}
...
{\centering \includegraphics[width=0.5\textwidth,height=\textheight]{SPAR_files/figure-pdf/unnamed-chunk-42-1.pdf}
...
{\centering \includegraphics[width=0.8\textwidth,height=\textheight]{SPAR_files/figure-pdf/unnamed-chunk-49-1.pdf}
...
{\centering \includegraphics[width=0.5\textwidth,height=\textheight]{SPAR_files/figure-pdf/unnamed-chunk-50-1.pdf}
