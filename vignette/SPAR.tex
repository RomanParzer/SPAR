...
#>     return(out)
#>   }
#> <bytecode: 0x138f4a0a8>
#> <environment: 0x138f40428>
\end{verbatim}
...
#>               nu=1.37e-02 leading to 1073 / 2000 active predictors.
#> Summary of those non-zero coefficients:
#>     Min.  1st Qu.   Median     Mean  3rd Qu.     Max. 
#> -0.95409 -0.07506  0.02183  0.02765  0.12467  1.14085
\end{verbatim}
...
R> spar_cv
#> spar.cv object:
#> Smallest CV-Meas 2216.8 reached for nummod=30,
#>               nu=0.00e+00 leading to 1846 / 2000 active predictors.
#> Summary of those non-zero coefficients:
#>      Min.   1st Qu.    Median      Mean   3rd Qu.      Max. 
#> -0.765845 -0.039688  0.004206  0.018347  0.070165  0.988682 
#> 
#> Sparsest coefficient within one standard error of best CV-Meas
#>               reached for nummod=5, nu=8.35e-03 
#> leading to 859 / 2000 active
#>               predictors with CV-Meas 2903.4.
#> Summary of those non-zero coefficients:
#>     Min.  1st Qu.   Median     Mean  3rd Qu.     Max. 
#> -0.93949 -0.12273  0.06197  0.03790  0.18753  1.04567
\end{verbatim}
...
#> List of 4
#>  $ intercept: num 2.8
#>  $ beta     : num [1:2000] 0.0308 0 0.6535 0 0 ...
#>  $ nummod   : num 25
#>  $ nu       : num 0.0137
\end{verbatim}
...
\texttt{screen\_*} function. Moreover, we do not perform any
thresholding.
