...
#   nummods=c(5,10,15,20,25,30))
# check(all.equal(spar_res$betas@x[1:9],
#                 c(0.000112751308362133, 0.010547748879952, 0.000508057984557986,
#                   -0.000405592453426605, -0.00157396278165833, -0.00187602401643014,
#                   -0.000282182720908338, -0.000459492548046985, 0.0167243541106617)))
#
